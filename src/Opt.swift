...
public struct Opt {
    public static var MAXNWTCPSocketReadDataSize = 8912  //128 * 1024
    ...
    public static var UDPSocketActiveTimeout = 150 // 300

    public static var UDPSocketActiveCheckInterval = 30 // 60

    public static var MAXHTTPContentBlockLength = 10240

    public static var RejectAdapterDefaultDelay = 3 // 300

    public static var DNSTimeout = 1

    public static var forwardReadInterval = 0 // 50
}
